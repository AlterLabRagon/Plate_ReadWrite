...
exp_name <- 'Nadege_plate'
save_path <- '/Users/maanasa/Desktop/Plate_ReadWrite_new/Plate_ReadWrite/Nadege/plate_example/'
QC_check <- 40
platemap_long <- FALSE
...
source_url("https://raw.githubusercontent.com/AlterLabRagon/Plate_ReadWrite/main/Format_checks2.R")
source_url("https://raw.githubusercontent.com/AlterLabRagon/Plate_ReadWrite/main/convert_384..R")
...
##########################################################################
check_dim_combined(plate_data_tidyr,pre_combined_data,combined_data,save_path,sample_meta_data,exp_df,anno_col,QC_exp_data,QC_masked_data,summary_stats_edited)
...
# Account for when duplicates are performed on different plates for summary statistics?
# We can do region to antigen mapping based on whether there are multiple beads or one bead