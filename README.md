To use Plate_ReadWrite you can download the entire folder and click on the User_friendly_version_new.R script. You can find example data and an annotated R Markdown Guide in the examples section. 
